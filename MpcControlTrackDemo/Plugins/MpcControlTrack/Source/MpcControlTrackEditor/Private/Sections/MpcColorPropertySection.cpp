...
void FMpcColorPropertySection::GenerateSectionLayout( class ISectionLayoutBuilder& LayoutBuilder ) const
{
	UMovieSceneMpcColorSection* ColorSection = Cast<UMovieSceneMpcColorSection>( &SectionObject );
	...
	LayoutBuilder.AddKeyArea( "R", NSLOCTEXT( "FMpcColorPropertySection", "RedArea", "Red" ), RedKeyArea.ToSharedRef() );
	LayoutBuilder.AddKeyArea( "G", NSLOCTEXT( "FMpcColorPropertySection", "GreenArea", "Green" ), GreenKeyArea.ToSharedRef() );
	LayoutBuilder.AddKeyArea( "B", NSLOCTEXT( "FMpcColorPropertySection", "BlueArea", "Blue" ), BlueKeyArea.ToSharedRef() );
	LayoutBuilder.AddKeyArea( "A", NSLOCTEXT( "FMpcColorPropertySection", "OpacityArea", "Opacity" ), AlphaKeyArea.ToSharedRef() );
}


int32 FMpcColorPropertySection::OnPaintSection( FSequencerSectionPainter& Painter ) const
{
	...
	const UMovieSceneMpcColorSection* ColorSection = Cast<const UMovieSceneMpcColorSection>( &SectionObject );
...
void FMpcColorPropertySection::ConsolidateColorCurves( TArray< TKeyValuePair<float, FLinearColor> >& OutColorKeys, const UMovieSceneMpcColorSection* Section ) const
{
...
FLinearColor FMpcColorPropertySection::FindSlateColor(const FName& ColorName) const
{
...
void FMpcColorPropertySection::SetIntermediateValue( FPropertyChangedParams PropertyChangedParams )
{
...
void FMpcColorPropertySection::ClearIntermediateValue()
{
