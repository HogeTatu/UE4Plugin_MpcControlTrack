...
*/
class FMpcColorPropertySection
...
public:
	 ...
	 */
	FMpcColorPropertySection(UMovieSceneSection& InSectionObject, ISequencer* InSequencer, UMovieSceneTrack& InTrack)
		: FPropertySection(InSectionObject, InTrack.GetDisplayName())
		, Sequencer(InSequencer)
		, Track(*Cast<UMovieSceneMpcColorTrack>(&InTrack))
	{ }
...
protected:
	...
	void ConsolidateColorCurves(TArray< TKeyValuePair<float, FLinearColor> >& OutColorKeys, const UMovieSceneMpcColorSection* Section) const;
...
private:
	...
	UMovieSceneMpcColorTrack& Track;
};
